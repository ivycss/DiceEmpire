...
<body>
    ...
    <p>Si è verificato un errore durante la registrazione. Si prega di riprovare controllando attentamente di aver messo tutti i campi rispettando i relativi formati.</p>
    <a href="signup.jsp" class="button">Torna alla Registrazione</a>
</body>
</html>
